...
void Thor::on_btnConfirmBooking1_clicked() {
    ...
    QSqlQuery query(db);
    query.prepare("UPDATE Seats SET is_available = 0 WHERE seat_id = :seat_id AND showtime_id = 6");
...
void Thor::on_btnSelectSeat1_clicked()
{
