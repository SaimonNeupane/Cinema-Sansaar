...
Sinister::Sinister(QString loggedInUser,QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::Sinister)
...
void Sinister::initializeDatabase() {
...
void Sinister::on_btnConfirmBooking1_clicked() {
...
void Sinister::on_btnSelectSeat1_clicked()
{
